...
function CustomEdge(props: EdgeProps<CustomEdgeEdge>) {
  ...
  return (
    <>
      ...
      <EdgeLabelRenderer>
        <div
          className={`pointer-events-none absolute flex items-center gap-1 rounded-md border bg-white px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide shadow-[0_1px_2px_rgba(15,23,42,0.06)] ${token.badgeBg} ${token.badgeText} ${token.badgeBorder} ${edgeType === 'INVALIDATES' ? 'font-bold' : ''}`}
          style={{
