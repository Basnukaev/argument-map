...
См. корневой `../CLAUDE.md` секция «Когда запускать билды/тесты»
и memory `feedback_no_frequent_builds.md`. Кратко - **не на каждом
...
Мелкие правки одного класса - не запускать
