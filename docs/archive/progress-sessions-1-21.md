# Архивный лог progress - Сессии 0-21

Этот файл - архив старых записей `docs/progress.md`. Содержит хронологию
сессий с Сессии 0 (инициализация) по Сессию 21 включительно.

**Когда читать:** только при необходимости исторического контекста.
Для текущей работы используйте актуальный `docs/progress.md` (Сессии 22+).

Архивирован: 2026-05-11 в рамках Cleanup Marathon (Phase 5). Цель -
снизить токен-расход для будущих сессий Claude Code (был 4835 LOC,
стал ~1200 LOC актуального).
